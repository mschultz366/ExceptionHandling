...
fun getCommercial() {
    ...
    val property: String ?= try { readLine()!! } catch(e: Exception) {null}
    print("Enter name: ")
    val name: String ?= try { readLine()!! } catch(e: Exception) {null}
    print("Enter phone: ")
    val phone: String ?= try { readLine()!! } catch(e: Exception) {null}
    print("Enter Address: ")
    val address: String ?= try { readLine()!! } catch(e: Exception) {null}
    print("Enter Sq Footage: ")
    val sqFootage: Double ?= try { readLine()!!.toDouble() } catch(e: Exception) {null}
